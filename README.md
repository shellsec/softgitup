...
> 共 **21** 款软件、**4,789** 个文件，合计 **1.61 GB**；统计时间 2026-07-03 18:07。
> 体积 Top5：system_good (677.5 MB)、PotPlayer (252.4 MB)、UltraEdit (198.3 MB)、gh-release-fetch (88.2 MB)、notepad++ (72.9 MB)。
<!-- SOFTWARE_SIZE_END -->
