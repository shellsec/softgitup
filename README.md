...
> 共 **21** 款软件、**4,195** 个文件，合计 **1.62 GB**；统计时间 2026-08-24 11:35。
> 体积 Top5：system_good (698.4 MB)、PotPlayer (253.1 MB)、UltraEdit (202.3 MB)、WiseCare365 (74.3 MB)、notepad++ (73.7 MB)。
<!-- SOFTWARE_SIZE_END -->
