...
> 共 **21** 款软件、**4,163** 个文件，合计 **1.61 GB**；统计时间 2026-07-27 14:44。
> 体积 Top5：system_good (690.0 MB)、PotPlayer (249.3 MB)、UltraEdit (202.3 MB)、WiseCare365 (74.3 MB)、notepad++ (73.6 MB)。
<!-- SOFTWARE_SIZE_END -->
