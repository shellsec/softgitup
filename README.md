...
> 共 **21** 款软件、**4,781** 个文件，合计 **1.62 GB**；统计时间 2026-06-28 15:09。
> 体积 Top5：system_good (677.5 MB)、PotPlayer (263.1 MB)、UltraEdit (198.3 MB)、gh-release-fetch (88.2 MB)、notepad++ (72.9 MB)。
<!-- SOFTWARE_SIZE_END -->
