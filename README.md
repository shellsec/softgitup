...
> 共 **21** 款软件、**4,770** 个文件，合计 **1.61 GB**；统计时间 2026-06-27 18:01。
> 体积 Top5：system_good (677.5 MB)、PotPlayer (263.1 MB)、UltraEdit (198.3 MB)、gh-release-fetch (73.8 MB)、notepad++ (72.9 MB)。
<!-- SOFTWARE_SIZE_END -->
