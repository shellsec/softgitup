...
> 共 **21** 款软件、**4,686** 个文件，合计 **1.57 GB**；统计时间 2026-06-23 11:31。
> 体积 Top5：system_good (677.3 MB)、PotPlayer (262.9 MB)、UltraEdit (198.3 MB)、notepad++ (72.9 MB)、SublimeText (66.1 MB)。
<!-- SOFTWARE_SIZE_END -->
