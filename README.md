...
> 共 **21** 款软件、**4,078** 个文件，合计 **1.52 GB**；统计时间 2026-06-16 17:22。
> 体积 Top5：system_good (665.5 MB)、PotPlayer (260.5 MB)、UltraEdit (198.3 MB)、notepad++ (72.9 MB)、SublimeText (66.1 MB)。
<!-- SOFTWARE_SIZE_END -->
