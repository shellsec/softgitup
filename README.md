...
> 共 **21** 款软件、**4,780** 个文件，合计 **1.62 GB**；统计时间 2026-06-28 11:58。
> 体积 Top5：system_good (677.5 MB)、PotPlayer (263.1 MB)、UltraEdit (198.3 MB)、gh-release-fetch (87.3 MB)、notepad++ (72.9 MB)。
<!-- SOFTWARE_SIZE_END -->
