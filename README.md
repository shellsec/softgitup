...
> 共 **21** 款软件、**4,214** 个文件，合计 **1.65 GB**；统计时间 2026-08-31 15:21。
> 体积 Top5：system_good (732.8 MB)、PotPlayer (253.1 MB)、UltraEdit (202.3 MB)、WiseCare365 (74.3 MB)、notepad++ (73.7 MB)。
<!-- SOFTWARE_SIZE_END -->
