...
| 批处理 | 作用 |
|--------|------|
| `monthly_check_hybase.bat` | hybase 系统 + 移动 |
| `monthly_check_dayanzai.bat` | dayanzai 系统（有 URL 才跑）+ 移动 |
| `monthly_check_down66.bat` | down66 系统（有 URL 才跑）+ 移动 |
| `monthly_check_list.bat` | 上述 8 个 scope 连跑 |
| `open_changed_*.bat` | 分别打开系统/移动变化 URL |
