...
string GetDesc()
{
	return "http://www.yifysubtitles.me";
}
...
array<dictionary> SubtitleSearch(string MovieFileName, dictionary MovieMetaData)
{
	...
	string api = "https://yts.mx/api/v2/list_movies.json?query_term=" + title;
											...
											for (int j = 0, len = langs.size(); j < len; j++)
											{
												...
												if (it.isObject())
												{
													...
													{													
														...
														item["lang"] = lang;
														item["url"] = "http://www.yifysubtitles.me/movie-imdb/" + imdb;
...
{
	string api = "http://www.yifysubtitles.me" + download;
