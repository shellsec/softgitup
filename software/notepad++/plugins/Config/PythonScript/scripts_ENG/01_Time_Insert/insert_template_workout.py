# -*- coding: utf-8 -*-
"""Workout · same fields as 插入模板_运动; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "Workout today: (what + duration or intensity)",
            "",
            "How it felt: (tired / good / pain…)",
            "",
            "Gear / strain / watch-outs: (or \"none\")",
            "",
            "Tomorrow: (move or rest, one line)",
            "",
            "---",
        ]
    ),
