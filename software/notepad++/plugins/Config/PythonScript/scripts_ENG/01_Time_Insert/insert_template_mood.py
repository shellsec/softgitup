# -*- coding: utf-8 -*-
"""Mood / emotion · same fields as 插入模板_情绪; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "Trigger: (event or thought)",
            "",
            "Body feeling: (tight / heavy / heart rate, optional)",
            "",
            "What I need: (heard? alone? say it out?)",
            "",
            "One self-regulation step: (concrete action)",
            "",
            "---",
        ]
    ),
