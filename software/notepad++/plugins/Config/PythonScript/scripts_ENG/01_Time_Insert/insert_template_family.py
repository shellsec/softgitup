# -*- coding: utf-8 -*-
"""Family · same fields as 插入模板_家庭; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "Home errands / logistics: (pickup, shopping, repairs, housework…)",
            "",
            "Family: (one thing to say, or comms memo)",
            "",
            "Tomorrow at home: (one small thing)",
            "",
            "---",
        ]
    ),
