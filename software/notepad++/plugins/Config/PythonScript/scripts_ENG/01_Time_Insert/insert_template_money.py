# -*- coding: utf-8 -*-
"""Money · same fields as 插入模板_财务; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "Money in / out: (one entry or daily total)",
            "",
            "Bills / memos: (payments, subs, reimburse reminders)",
            "",
            "Next step: (to-do or \"none\")",
            "",
            "---",
        ]
    ),
