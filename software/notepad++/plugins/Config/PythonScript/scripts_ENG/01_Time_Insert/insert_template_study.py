# -*- coding: utf-8 -*-
"""Study · same fields as 插入模板_学习; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "What I studied: (one line in your own words)",
            "",
            "Stuck on: (write \"none\" if none)",
            "",
            "Next start from: (a page / section / one problem)",
            "",
            "---",
        ]
    ),
