# -*- coding: utf-8 -*-
"""Project · same fields as 插入模板_项目; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "Project today: (one line — what, where you are)",
            "",
            "Progress: (phase or % as you like)",
            "",
            "Dependencies / risks: (people/things or \"none\")",
            "",
