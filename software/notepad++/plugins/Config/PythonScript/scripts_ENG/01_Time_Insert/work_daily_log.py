# -*- coding: utf-8 -*-
"""Work · log; same fields as 工作日记_流水; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "Work note: (a few short lines, timeline-style)",
            "",
            "Todos: (scratch not yet in issue/calendar; real tasks stay in the system)",
            "",
            "---",
        ]
    ),
