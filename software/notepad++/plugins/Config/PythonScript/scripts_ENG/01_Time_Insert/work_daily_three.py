# -*- coding: utf-8 -*-
"""Work · three bullets; same fields as 工作日记_三点; blank line after each prompt; CRLF."""
import os
import sys
...
editor.insertText(
    ...
    template_block(
        [
            ts,
            "Work done: (checkable: shipped what / aligned with whom)",
            "",
            "Work in progress: (what is moving now)",
            "",
            "Work blocked: (missing: person, decision, or tech unknown)",
            "",
            "---",
        ]
    ),
