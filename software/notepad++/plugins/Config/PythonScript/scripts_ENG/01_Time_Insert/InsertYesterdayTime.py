# -*- coding: utf-8 -*-
"""Insert yesterday's English long date string (format_en)."""
import os
import sys
...
try:
    from time_stamp_fmt import format_en, shift_days
except ImportError:
...
editor.insertText(editor.getCurrentPos(), format_en(shift_days(-1)))
